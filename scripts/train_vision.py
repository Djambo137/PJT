...
def parse_args(argv: Sequence[str] | None = None) -> VisionConfig:
    ...
    parser.add_argument("dataset", type=Path, help="Path to vision_dataset.json or .jsonl")
    parser.add_argument("--image-zip", type=Path, default=None, help="Optional ZIP archive containing PNG images")
